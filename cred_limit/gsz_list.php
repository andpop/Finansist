...
<body>
	<?php
		...
		function add_item_form()
		{
            ...
            echo '<input type="text" class="form-control" name="GSZ_Brief_Name" id="GSZ_Brief_Name" placeholder="Краткое название ГСЗ">';
        	echo '</div>';
        	echo '<div class="form-group">';
            echo '<label for="GSZ_Full_Name">Описание</label>';
            echo '<input type="text" class="form-control" name="GSZ_Full_Name" id="GSZ_Full_Name" placeholder="Описание ГСЗ">';
        	echo '</div>';
		...
		function edit_item_form()
		{
	        ...
	        echo '<div class="form-group">';
            echo '<label for="GSZ_Brief_Name">Название</label>';
            echo '<input type="text" class="form-control" name="GSZ_Brief_Name" id="GSZ_Brief_Name" value="'.$row['Brief_Name'].'">';
        	echo '</div>';
        	echo '<div class="form-group">';
            echo '<label for="GSZ_Full_Name">Описание</label>';
            echo '<input type="text" class="form-control" name="GSZ_Full_Name" id="GSZ_Full_Name" value="'.$row['Full_Name'].'">';
        	echo '</div>';
        	echo '<button type="submit" class="btn btn-primary">Сохранить</button> ';
        	echo '<button type="button" class="btn btn-warning" onClick="history.back();">Отменить</button>';
        	echo '</form>';
